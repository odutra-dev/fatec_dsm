...
export default function Losango() {
  ...
  return (
    <Animated.View style={[viewAnimatedStyle]}>
      <Animated.Text style={[textPrimaryAnimatedStyle]}>Losango</Animated.Text>
      <Animated.Image
        style={{
          width: 200,
          height: 200,
        ...
        source={{
          uri: "https://uploads-cdn.omnicalculator.com/images//geometry/perimeter/rhombus1-r2.svg?width=425&enlarge=0&format=webp",
        }}
      ></Animated.Image>
